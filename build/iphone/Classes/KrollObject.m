...
//@interface PMPPrepObject : NSObject
//@end

@interface PMPPrepObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PMPPrepObject class]])
		{
			for (NSString *key in [[(PMPPrepObject*)o modules] allKeys])
			{
