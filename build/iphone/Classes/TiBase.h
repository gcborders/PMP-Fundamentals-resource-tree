...
// in simulator we redefine to format for PMPPrep Developer console
...
{\
	NSString * exceptionName = [@"org.pmpprep." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pmpprep";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPMPPrepNativeItemNone = -1, 
	UIPMPPrepNativeItemSpinner = -2,
	UIPMPPrepNativeItemProgressBar = -3,
	
	UIPMPPrepNativeItemSlider = -4,
	UIPMPPrepNativeItemSwitch = -5,
	UIPMPPrepNativeItemMultiButton = -6,
	UIPMPPrepNativeItemSegmented = -7,
	
	UIPMPPrepNativeItemTextView = -8,
	UIPMPPrepNativeItemTextField = -9,
	UIPMPPrepNativeItemSearchBar = -10,
	
	UIPMPPrepNativeItemPicker = -11,
	UIPMPPrepNativeItemDatePicker = -12,
	
	UIPMPPrepNativeItemInfoLight = -13,
	UIPMPPrepNativeItemInfoDark = -14,
	
	UIPMPPrepNativeItemDisclosure = -15,
	
	UIPMPPrepNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PMPPrep instances of
